...
class NeuronBuilder:
    ...
    def __init__(self, tau_2, growing_metric):
        if not NeuronBuilder.__instance:
            NeuronBuilder.__instance = NeuronBuilder.__SingletonNeuronBuilder(tau_2, growing_metric)

    def __getattr__(self, item):
        return getattr(NeuronBuilder.__instance, item)
